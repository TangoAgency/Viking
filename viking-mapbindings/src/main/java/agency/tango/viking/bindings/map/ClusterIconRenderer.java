...
public class ClusterIconRenderer<T extends ClusterItem> extends DefaultClusterRenderer<T>
    implements ClusterRenderer<T> {
  private final int markerIcon;

  public ClusterIconRenderer(Context context, GoogleMap map, ClusterManager<T> clusterManager,
